...
Versi fitur saat ini: `0.2.0` (`versionCode 3`). Semua fungsi utama berjalan lokal di HP owner tanpa akun, server, atau internet.
...
- satu PIN Laporan offline yang disimpan sebagai hash;
